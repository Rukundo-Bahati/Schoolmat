          ...
          {showChangePassword && (
            <div className="space-y-4 pt-4 border-t">
              <div>
                ...
                <Input type="password" className="rounded-full" placeholder="Enter current password" />
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">New Password</label>
                <Input type="password" className="rounded-full" placeholder="Enter new password" />
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">Confirm New Password</label>
                <Input type="password" className="rounded-full" placeholder="Confirm new password" />
              </div>
              <div className="flex space-x-4">
                <Button className="rounded-full bg-blue-700 hover:bg-blue-800">Update Password</Button>
                <Button
                  variant="outline"
                  onClick={onPasswordToggle}
                  className="rounded-full"
