...
export function ProductDetailsModal({ product, isOpen, onClose, onViewPurchase }: ProductDetailsModalProps) {
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-3 pt-4">
                <Button
                  ...
                  className="flex-1 rounded-full bg-blue-700 hover:bg-blue-800"
