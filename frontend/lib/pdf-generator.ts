...
export const generateOrderHistoryPDF = async (orders: OrderData[], parentInfo: any, schoolInfo: SchoolInfo) => {
  ...
  for (let i = 1; i <= pageCount; i++) {
    ...
    doc.setFontSize(8)
    doc.setTextColor(100, 100, 100)
    doc.text(`Page ${i} of ${pageCount}`, pageWidth - margin - 20, (doc as any).internal.pageSize.height - 10)
    doc.text("Generated by SchoolMart System", margin, (doc as any).internal.pageSize.height - 10)
  }
