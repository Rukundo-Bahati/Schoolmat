...
export default function ResetPasswordPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await resetPassword(email!, formData.otp, formData.password)
      setIsSuccess(true)
    } catch (error: any) {
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <Input
                  ...
                  className={`rounded-full py-3 px-4 text-base ${errors.otp ? "border-red-500" : ""}`}
              ...
              <div>
                ...
                <div className="relative">
                  <Input
                    ...
                    className={`rounded-full py-3 px-4 pr-12 text-base ${errors.confirmPassword ? "border-red-500" : ""}`}
